...
import { X, Check, Crown, Headphones, Star } from "lucide-react";
import React from "react";
import modalBgHombre from "../assets/logosnovedades/modalhombre.jpg";
...
export const SubscriptionModal = ({ isOpen, onClose }: SubscriptionModalProps) => {
  const handleSubscription = () => {
    window.location.href = 'https://mangamukai.com/compre-una-suscripcion-vid';
  };
                    ...
                    >
                      ...
                      <div className="mt-auto pb-4 md:pb-0">
                        <button
                          ...
                          className="w-full py-3.5 bg-white hover:bg-[#FF4D88] hover:text-white text-black font-black uppercase tracking-[0.05em] text-xs rounded-xl border border-transparent transition-all flex items-center justify-center gap-3 group shadow-lg shadow-white/10"
                        >
