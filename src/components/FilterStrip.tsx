// 1. Eliminamos "import React from 'react';" porque no se usa y causaba el error.
...
const FilterStrip = ({ activeCategory, onCategoryChange }: FilterStripProps) => {
  ...
  return (
    <>
      <style>{`
        ...
        .beam {
          background: linear-gradient(90deg, transparent 0%, #ec4899 80%, transparent 100%);
          width: 100%;
          height: 100%;
          opacity: 1;
        }
      ...
      <div className="relative z-40 w-full bg-black -mt-10 md:-mt-10 lg:-mt-10 pt-0 overflow-hidden pb-0 block">
